...
namespace NRoles.Engine.Test.Support {
  ...
  [RoleTest(
    CompositionType = typeof(Role_With_Event_Composition),
    TestType = typeof(Role_With_Event_Test))]
  public class Role_With_Event : Role {
    public event EventHandler MyEvent = delegate { };
    public void Operation() { FireEvent(); }
    private void FireEvent() { MyEvent(this, EventArgs.Empty); }
  }
  public class Role_With_Event_Composition : Does<Role_With_Event> { }
  public class Role_With_Event_Test : DynamicTestFixture {
    public override void Test() {
      var role = new Role_With_Event_Composition().As<Role_With_Event>();
      string str = null;
