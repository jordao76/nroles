...
namespace NRoles.Engine.Test.Support {
  ...
  [RoleTest(CompositionType = typeof(Role_With_Property_Composition_With_Property_Superseded))]
  [RoleTest(CompositionType = typeof(Derived_Class_From_Base_Class_With_Property))]
  public interface IRole_With_Property : Role {
    int Property { get; }
  }
  public class Role_With_Property_Composition_With_Property_Superseded : Does<IRole_With_Property> {
